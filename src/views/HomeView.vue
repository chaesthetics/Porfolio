...
<template>
  <div class="w-4/6 h-auto mt-[10%] flex justify-around shrink  mr-auto ml-auto bg-red-600 ">
    <div class="card flex items-center mt-1/2 aspect-auto">
      <div class="w-100 space-y-4 mb-10 aspect-auto">
